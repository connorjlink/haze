...
#define FORWARD_DECLARATION(enumerator, name, value, category) /* elide forward declarations */
	...
	_PRIVATE_DEFINE_ENUM(ENUM_MEMBER_ADAPTER, SWITCH_CASE_ADAPTER, MAP_MEMBER_ADAPTER, FORWARD_DECLARATION, RISCV_REGISTERS, RISCVRegister, RISC-V register, /* fake */)
