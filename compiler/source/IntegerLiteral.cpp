...
namespace hz
{
	...
	std::intmax_t integer_literal_int(IntegerLiteral* value)
	{
		const auto raw = integer_literal_raw(value);
		return static_cast<std::intmax_t>(raw.magnitude) * (raw.sign ? 1 : -1);
	}
