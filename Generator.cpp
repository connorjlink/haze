...
namespace
{
    const std::unordered_map<hz::Register, std::string_view> register_map =
    {
        { hz::R0, "x" },
        { hz::R1, "y" },
        { hz::R2, "z" },
    ...
    const auto unmap = [](hz::Register r)
    {
