...
namespace hz
{
	...
	public:
		...
		TEST_METHOD(ValidateFunction)
		{
			...
			auto case1_helper2 = FunctionType{ .parameters = { MAKE_HANDLE(PointerType, Type, type_storage, std::move(case1_helper1)) }, .return_type = const_enum, .is_variadic = true };
			const auto case1 = PointerType{ .pointee = MAKE_HANDLE(FunctionType, Type, type_storage, std::move(case1_helper2)), .qualifier = TypeQualifier::CONST };
		...
		TEST_METHOD(ValidateArray)
		{
			...
			const auto case1 = ArrayType{ .element_type = MAKE_HANDLE(PointerType, Type, type_storage, std::move(case1_helper)), .length = 5 };
			...
			const auto case2 = PointerType{ .pointee = MAKE_HANDLE(ArrayType, Type, type_storage, std::move(case2_helper)), .qualifier = TypeQualifier::VOLATILE };
...
#pragma message("TODO: add per-type_storage handle/reference generation logic to reduce the wordiness by self-specializing the make_XX templates")
			...
			auto case3_func = FunctionType{ .parameters = { MAKE_HANDLE(PointerType, Type, type_storage, std::move(case3_func_param)) }, .return_type = const_enum, .is_variadic = true };
			auto case3_func_ptr = PointerType{ .pointee = MAKE_HANDLE(FunctionType, Type, type_storage, std::move(case3_func)), .qualifier = TypeQualifier::NONE };
			auto case3_helper1 = ArrayType{ .element_type = MAKE_HANDLE(PointerType, Type, type_storage, std::move(case3_func_ptr)), .length = 5 };
			auto case3_helper2 = PointerType{ .pointee = MAKE_HANDLE(ArrayType, Type, type_storage, std::move(case3_helper1)), .qualifier = TypeQualifier::NONE };
			const auto case3 = PointerType{ .pointee = MAKE_HANDLE(PointerType, Type, type_storage, std::move(case3_helper2)), .qualifier = TypeQualifier::NONE };
